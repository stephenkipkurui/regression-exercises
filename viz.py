...
def evaluation_example1(df, x, y):
    ...
    # add baseline
    plt.annotate('', xy=(70, y.mean()), xytext=(100, y.mean()), xycoords='data',
                 textcoords='data', arrowprops={'arrowstyle': '-', 'color': 'darkseagreen'})
    plt.text(100, 83,  'This line?', {
             'color': 'black', 'fontsize': 11, 'ha': 'left', 'va': 'center'})

    # add line connecting min and max of y
    plt.annotate('', xy=(70, y.min()), xytext=(100, y.max()), xycoords='data',
                 textcoords='data', arrowprops={'arrowstyle': '-', 'color': 'darkseagreen'})
    plt.text(100.5, 96,  'This line?', {
             'color': 'black', 'fontsize': 11, 'ha': 'left', 'va': 'center'})

    # add line that is translated up the y-axis a few points from the min/max line
    plt.annotate('', xy=(70, y.min()+3), xytext=(100, y.max()+3), xycoords='data',
                 textcoords='data', arrowprops={'arrowstyle': '-', 'color': 'darkseagreen'})
    plt.text(100, 99,  'This line?', {
             'color': 'black', 'fontsize': 11, 'ha': 'left', 'va': 'center'})
...
def evaluation_example2(df, x, y):
    ...
    plt.plot(x, df.yhat_predicted, color='darkseagreen', linewidth=3)
...
def evaluation_example3(df, x, y, yhat):
    ...
    plt.annotate('', xy=(70, y.mean()), xytext=(102, df['y'].mean()), xycoords='data', textcoords='data', arrowprops={
                 'arrowstyle': '-', 'color': 'goldenrod', 'linewidth': 2, 'alpha': .75})
